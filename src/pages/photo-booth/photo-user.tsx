...
export default function PhotoUser() {
  ...
  return (
    <div className="mx-auto flex min-h-screen flex-col items-center justify-center p-4">
      ...
      <div className="grid grid-cols-1 place-items-center gap-2 rounded-lg border-10 border-amber-400 bg-gradient-to-br from-sky-400 via-blue-400 to-indigo-400 p-3.5 shadow-lg">
